/* The purpose of this program is to retrieve the current OS level. The output
 * is sent to STDOUT but could be returned in passed variables or as a return value.
 * @parms
 *      *NONE
 */

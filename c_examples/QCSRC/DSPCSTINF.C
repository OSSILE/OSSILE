/* the purpose of this program is to show the constraints attached to the file
 * passed. Its hows how to use the API's required to gather this information and
 * use pointers to address that information.
 * @parms

     **
     **  Program . . : CBX9972
     **  Description : Work with Workstation Entries - CPP
     ...
     **-- UIM Panel exit program record:
     ...
     D  ExitPg                       20a   Inz( 'CBX9972E  *LIBL' )
     ...
     **-- Subsystem entry information:
     D SBSE0600        Ds                  Qualified  Based( pLstEnt )
     D  WksNam                       10a
     D  JobDscNam_q                  20a
     ...
     D  PxEntTyp                      5a
      ...
      /Free
        ...
        BegSr  BldWseLst;
          ...
          LstSbsEnt( USRSPC_Q: 'SBSE0600': PxSbsNam_q: ERRC0100 );
        ...
        BegSr  PrcUsrSpc;
          ...
          For  Idx = 1  to UsrSpcHdr.NumLstEnt;
            ...
            LstEnt.WksNam     = SBSE0600.WksNam;
            LstEnt.JobDscNam  = SBSE0600.JobDscNam;
            LstEnt.JobDscLib  = SBSE0600.JobDscLib;
            LstEnt.CtlJob     = SBSE0600.CtlJob;
            LstEnt.MaxActJob  = SBSE0600.MaxActJob;
            LstEnt.JobDscNam_q  = FmtQualNm( SBSE0600.JobDscNam_q );
            LstEnt.JobDscTxt    = RtvObjDsc( SBSE0600.JobDscNam_q: '*JOBD' );

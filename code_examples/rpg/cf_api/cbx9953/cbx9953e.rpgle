     **
     **  Program . . : CBX9953E
     **  Description : Work with Job Queue Jobs - UIM Exit Program
     ...
     D  PxUimExit                          LikeDs( UimExit )
      ...
      /Free
        ...
        BegSr  JobQueAct;
          ...
          GetDlgVar( Type1.AppHdl: HdrRcd: %Size( HdrRcd ): 'HDRRCD': ERRC0100);
 
          Select;
          When  HdrRcd.JobQueSts = '1';
 
            PrcCmd( 'HLDJOBQ JOBQ('              +
                     %TrimR( HdrRcd.JobQueLib )  + '/' +
                     %TrimR( HdrRcd.JobQue )     + ')'
                  );
 
            HdrRcd.JobQueSts = '0';
 
          When  HdrRcd.JobQueSts = '0';
          ...
          PutDlgVar( Type1.AppHdl: HdrRcd: %Size( HdrRcd ): 'HDRRCD': ERRC0100);

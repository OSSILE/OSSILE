     **
     **  Program . . : CBX9963V
     **  Description : Submit Job Description Job - VCP
     ...
     **
     ...
     D  PxJobDsc_q                         LikeDs( ObjNam_q )
      ...
      /Free
        ...
        If  PxJobDsc_q.ObjNam = '*JOB';
          PxJobDsc_q.ObjNam = PxJobNam;
        EndIf;
 
        If  ChkObj( PxJobDsc_q: '*JOBD' ) = *Off;
 
          SndDiagMsg( 'CPD0006'
                    : '0000' +
                      RtvMsg( 'CPF2105': PxJobDsc_q + 'JOBD' )
                    );

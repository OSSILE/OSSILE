     **
     **  Program . . : CBX999V
     **  Description : Work with Remote Output Queues - VCP
     ...
     **
     ...
     D  PxOutOpt                      3a
      ...
      /Free
        ...
        If  %Scan( '*': PxRmtOutQue_q.ObjNam ) = *Zero   And
            ( %Scan( '*': PxRmtOutQue_q.ObjLib ) = *Zero  Or
              PxRmtOutQue_q.ObjLib = '*CURLIB'            Or
              PxRmtOutQue_q.ObjLib = '*LIBL' );
 
          If  ChkObj( PxRmtOutQue_q: '*OUTQ' ) = *Off;
 
            SndDiagMsg( 'CPD0006'
                      : '0000' +
                        RtvMsg( 'CPF2105': PxRmtOutQue_q + 'OUTQ' )
                      );
 
            SndEscMsg( 'CPF0002': 'QCPFMSG': NULL );
          EndIf;
        EndIf;

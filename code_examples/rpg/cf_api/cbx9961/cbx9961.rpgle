     **
     **  Program . . : CBX9961
     **  Description : Work with Prestart Job Entries - CPP
     ...
     **-- UIM Panel exit program record:
     ...
     D  ExitPg                       20a   Inz( 'CBX9961E  *LIBL' )
     ...
     **-- Subsystem entry information:
     D SBSE0500        Ds                  Qualified  Based( pLstEnt )
     D  PgmNam                       10a
     D  PgmLib                       10a
     D  UsrPrf                       10a
     D  StrJob                        1a
     ...
     D  JobNam                       10a
     D  JobDscNam_q                  20a
     D   JobDscNam                   10a   Overlay( JobDscNam_q:  1 )
     D   JobDscLib                   10a   Overlay( JobDscNam_q: 11 )
     D                                2a
     D  FstClsNam                    10a
     D  FstClsLib                    10a
     D  NbrFclJob                    10i 0
     D  SecClsNam_q                  20a
     D   SecClsNam                   10a   Overlay( SecClsNam_q:  1 )
     D   SecClsLib                   10a   Overlay( SecClsNam_q: 11 )
     D  NbrSclJob                    10i 0
     D  JobTraGrp                    10a
     D  JobTraLvl                    10a
     D  JobRsc                       10a
      ...
      /Free
        ...
        *InLr = *On;
        ...
        BegSr  BldPjeLst;
          ...
          LstSbsEnt( USRSPC_Q: 'SBSE0500': PxSbsNam_q: ERRC0100 );
        ...
        BegSr  PrcUsrSpc;
          ...
          For  Idx = 1  to UsrSpcHdr.NumLstEnt;
            ...
            LstEnt.JobNam     = SBSE0500.JobNam;
            LstEnt.JobDscNam  = SBSE0500.JobDscNam;
            LstEnt.JobDscLib  = SBSE0500.JobDscLib;
            LstEnt.PgmNam     = SBSE0500.PgmNam;
            LstEnt.PgmLib     = SBSE0500.PgmLib;
            LstEnt.UsrPrf     = SBSE0500.UsrPrf;
            LstEnt.StrJob     = SBSE0500.StrJob;
            LstEnt.WaitJob    = SBSE0500.WaitJob;
            LstEnt.InlNbrJob  = SBSE0500.InlNbrJob;
            LstEnt.ThrHld     = SBSE0500.ThrHld;
            LstEnt.AddNbrJob  = SBSE0500.AddNbrJob;
            LstEnt.MaxNbrJob  = SBSE0500.MaxNbrJob;
            LstEnt.MaxNbrUse  = SBSE0500.MaxNbrUse;
            LstEnt.PoolId     = SBSE0500.PoolId;
            LstEnt.FstClsNam  = SBSE0500.FstClsNam;
            LstEnt.FstClsLib  = SBSE0500.FstClsLib;
            LstEnt.NbrFclJob  = SBSE0500.NbrFclJob;
            LstEnt.SecClsNam  = SBSE0500.SecClsNam;
            LstEnt.SecClsLib  = SBSE0500.SecClsLib;
            LstEnt.NbrSclJob  = SBSE0500.NbrSclJob;
            LstEnt.JobTraGrp  = SBSE0500.JobTraGrp;
            LstEnt.JobTraLvl  = SBSE0500.JobTraLvl;
            LstEnt.JobRsc     = SBSE0500.JobRsc;
 
            LstEnt.SecClsNam_q  = FmtQualNm( SBSE0500.SecClsNam_q );
            LstEnt.JobDscNam_q  = FmtQualNm( SBSE0500.JobDscNam_q );
            LstEnt.JobDscTxt    = RtvObjDsc( SBSE0500.JobDscNam_q: '*JOBD' );

     ...
     **-- Subsystem entry information:
     D SBSE0700        Ds                  Qualified  Based( pLstEnt )
     D  WksTyp                       10a
     D  JobDscNam_q                  20a
      ...
      /Free
        ...
        *InLr = *On;
        ...
        BegSr  BldWseLst;
          ...
          LstSbsEnt( USRSPC_Q: 'SBSE0700': PxSbsNam_q: ERRC0100 );
        ...
        BegSr  PrcUsrSpc;
          ...
          For  Idx = 1  to UsrSpcHdr.NumLstEnt;
            ...
            LstEnt.WksTyp     = SBSE0700.WksTyp;
            LstEnt.JobDscNam  = SBSE0700.JobDscNam;
            LstEnt.JobDscLib  = SBSE0700.JobDscLib;
            LstEnt.CtlJob     = SBSE0700.CtlJob;
            LstEnt.MaxActJob  = SBSE0700.MaxActJob;
            LstEnt.JobDscNam_q  = FmtQualNm( SBSE0700.JobDscNam_q );
            LstEnt.JobDscTxt    = RtvObjDsc( SBSE0700.JobDscNam_q: '*JOBD' );

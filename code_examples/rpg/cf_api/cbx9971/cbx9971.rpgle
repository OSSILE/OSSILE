     **
     **  Program . . : CBX9971
     **  Description : Work with Communication Entries - CPP
     ...
     **-- UIM Panel exit program record:
     ...
     D  ExitPg                       20a   Inz( 'CBX9971E  *LIBL' )
     ...
     **-- Subsystem entry information:
     D SBSE0200        Ds                  Qualified  Based( pLstEnt )
     D  DevNam                       10a
     D  ModNam                        8a
     D  JobDscNam_q                  20a
      ...
      /Free
        ...
        *InLr = *On;
        ...
        BegSr  BldCmnLst;
          ...
          LstSbsEnt( USRSPC_Q: 'SBSE0200': PxSbsNam_q: ERRC0100 );
        ...
        BegSr  PrcUsrSpc;
          ...
          For  Idx = 1  to UsrSpcHdr.NumLstEnt;
            ...
            LstEnt.DevNam     = SBSE0200.DevNam;
            LstEnt.ModNam     = SBSE0200.ModNam;
            LstEnt.JobDscNam  = SBSE0200.JobDscNam;
            LstEnt.JobDscLib  = SBSE0200.JobDscLib;
            LstEnt.DftUsr     = SBSE0200.DftUsr;
            LstEnt.MaxActJob  = SBSE0200.MaxActJob;
            LstEnt.JobDscNam_q  = FmtQualNm( SBSE0200.JobDscNam_q );
            LstEnt.JobDscTxt    = RtvObjDsc( SBSE0200.JobDscNam_q: '*JOBD' );

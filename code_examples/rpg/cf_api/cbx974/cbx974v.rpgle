     **
     **  Program . . : CBX974V
     **  Description : Work with Default Journal - VCP
     ...
     **
     ...
     D  PxOutOpt                      3a
      ...
      /Free
        ...
        If  PxJrnLib > *Blanks  And  %Scan( '*': PxJrnLib ) = *Zero;
 
          If  ChkObj( PxJrnLib + '*LIBL': '*LIB' ) = *Off;
 
            SndDiagMsg( 'CPD0006'
                      : '0000' +
                        RtvMsg( 'CPF2105': PxJrnLib + 'LIB' )
                      );

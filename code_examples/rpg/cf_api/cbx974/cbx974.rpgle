     **
     **  Program . . : CBX974
     **  Description : Work with Default Journal - CPP
     ...
     **
     ...
     D ODP_SHR         c                   'N'
     D SPLF_NAM        c                   'PDFTJRN'
     D SPLF_USRDTA     c                   'WRKDFTJRN'
     D EJECT_NO        c                   'N'
      ...
      /Free
        ...
        *InLr = *On;
        ...
        BegSr  PrcLstEnt;
          ...
          LstEnt.JrnInf = GetDtaVal( ObjInf.ObjNam + ObjInf.ObjLib );

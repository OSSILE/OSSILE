     **
     **  Program . . : CBX9912
     **  Description : Remove User Auditing - CPP
     ...
     **-- Remove user audit level value:
     D RmvAudVal       Pr           300a   Varying
     D  PxAudLst                    300a   Const  Varying
     D  PxAudVal                     10a   Const  Varying
     **-- Process command:
     D PrcCmd          Pr            10i 0
        ...
        BegSr  PrcLstEnt;
          ...
          If  ERRC0100.BytAvl = *Zero;
            ...
            If  PxUsrCls = '*ANY'  Or  PxUsrCls = USRI0300.UsrCls;
              ...
              If  PxObjAud = USRI0300.ObjAudVal  Or  PxObjAud = '*ANY';
                PxObjAud = '*NONE';
              ...
              Else;
                ...
                For  Idx = 1  To  PxAudLvl.NbrVal;
                  ...
                  Select;
                  When  PxAudLvl.AudVal(1) = '*ALL';
                    AudCnt += 1;
                    AudStr  = '*NONE';
 
                  When  %Scan( PxAudLvl.AudVal(Idx): AudStr ) > *Zero;
                    AudCnt += 1;
                    AudStr  = RmvAudVal( AudStr: PxAudLvl.AudVal(Idx));
                  EndSl;
                EndFor;
              EndIf;
     ...
     **-- Local variables:
     D Pos             s             10i 0
     D AudVal          s             10a   Varying
     D RtnAudLst       s            300a   Varying  Inz( NULL )
 
      /Free
 
        AudVal = PxAudVal + ' ';
 
        Pos = %Scan( AudVal: PxAudLst );
 
        If  Pos > *Zero;
          RtnAudLst = %Replace( NULL: PxAudLst: Pos: %Len( AudVal ));
        EndIf;

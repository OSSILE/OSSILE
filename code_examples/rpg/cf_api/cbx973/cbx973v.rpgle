     **
     **  Program . . : CBX973V
     **  Description : Set Default Journal - VCP
     ...
     **
     ...
     D  OfsVal                        5i 0 Dim( 5 )
     **
     D JrnOpt          Ds                  Qualified  Dim( 5 )  Based( pJrnOpt )
     ...
     **
     ...
     D  PxCrtDtaAra                   4a
      ...
      /Free
        ...
        If  ChkObj( PxLibNam + 'QSYS': '*LIB' ) = *Off;
 
          SndDiagMsg( 'CPD0006': '0000' + RtvMsg( 'CPF9810': PxLibNam ));
 
          SndEscMsg( 'CPF0002': '' );
        EndIf;
 
        If  PxCrtDtaAra = '*NO'  And
            ChkObj( DftJrn + PxLibNam: '*DTAARA' ) = *Off;
 
          SndDiagMsg( 'CPD0006'
                    : '0000' +
                      RtvMsg( 'CPF2105': DftJrn + PxLibNam + 'DTAARA' )
                    );
        ...
        If  PxCrtDtaAra = '*YES'  And
            ChkObj( DftJrn + PxLibNam: '*DTAARA' ) = *On;
 
          SndDiagMsg( 'CPD0006'
                    : '0000' +
                      RtvMsg( 'CPD2104': DftJrn + PxLibNam + 'DTAARA' )
                    );

     **
     **  Program . . : CBX994E
     **  Description : Work with Query Profile Options - UIM Exit Program
     ...
     **
     **  Compile options:
     **    CrtRpgMod  Module( CBX994E CBX994 )
     **               DbgView( *LIST )
     **
     **    CrtPgm     Pgm( CBX994E )
     **               Module( CBX994E )
      ...
      /Free
        ...
        When  PxUimExit.TypCall = 1;
          ...
          If  Type1.FncKey = 22;
            ...
            If  CsrRcd.CsrEid = NO_ENT  Or  CsrRcd.CsrVar <> 'PRFOPT';
        ...
        BegSr  ChgLstEnt1;
          ...
          LstEnt.PrfOpt = GetDtaVal( LstEnt.DtaAra + LstEnt.DtaLib );
        ...
        BegSr  RunCsrAct;
          ...
          DspLngTxt( %TrimR( LstEnt.PrfOpt )
                   : %Len( %TrimR( LstEnt.PrfOpt ))
                   : 'CBX0101'
                   : 'CBX994M   *LIBL'
                   : ERRC0100
                   );

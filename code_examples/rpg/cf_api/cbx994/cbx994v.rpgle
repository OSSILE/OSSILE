     **
     **  Program . . : CBX994V
     **  Description : Work with Query Profile Options - VCP
     **  Author  . . : Carsten Flensburg
     **  Published . : System iNetwork Systems Management Tips Newsletter
     **
     **
     **  Program description:
     **    Validity checking program for default journal library existence
     **    in case of specific library name.
     **
     **
     **
     **  Compile options:
     **    CrtRpgMod Module( CBX994V )
     **              DbgView( *LIST )
     **
     **    CrtPgm    Pgm( CBX994V )
     **              Module( CBX994V )
     ...
     **
     ...
     D  PxOutOpt                      3a
      ...
      /Free
        ...
        If  PxOptLib > *Blanks  And  %Scan( '*': PxOptLib ) = *Zero;
 
          If  ChkObj( PxOptLib + '*LIBL': '*LIB' ) = *Off;
 
            SndDiagMsg( 'CPD0006'
                      : '0000' +
                        RtvMsg( 'CPF2105': PxOptLib + 'LIB' )
                      );

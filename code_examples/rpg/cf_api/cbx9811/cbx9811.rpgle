     **
     **  Program . . : CBX9811
     **  Description : Add User Query Attributes - CPP
     **  Author  . . : Carsten Flensburg
     **  Published . : System iNetwork Systems Management Tips Newsletter
     **
     **
     **  Program description:
     **    Command processing program for the Add User Query Attributes
     **    (ADDUSRQRYA) command.
     **
     **
     **  Compile options:
     **    CrtRpgMod Module( CBX9811 )
     **              DbgView( *LIST )
     **
     **    CrtPgm    Pgm( CBX9811 )
     **              Module( CBX9811 )
     ...
     **
     ...
     D  PxQryOptLib                  10a
      ...
      /Free
        ...
        UsrQryAtr.QryIntAlw = '*NO';
        UsrQryAtr.QryOptLib = PxQryOptLib;
 
        SetUsrQryA( PxUsrPrf: UsrQryAtr );
 
        SndCmpMsg ( 'User query attributes added for user '  +
                     %Trim( PxUsrPrf )                       +
                    '.'
                  );

     **
     **  Program . . : CBX998V
     **  Description : Work with Subsystem Entries - VCP
     ...
     **
     ...
     D  PxExcLib                     10a
      ...
      /Free
        ...
        If  %Scan( '*': PxSbsNam_q.ObjNam ) = *Zero;
        ...
        If  PxExcLib > *Blanks  And  %Scan( '*': PxExcLib: 2 ) = *Zero;
 
          If  ChkObj( PxExcLib + '*LIBL': '*LIB' ) = *Off;
 
            SndDiagMsg( 'CPD0006'
                      : '0000' +
                        RtvMsg( 'CPF2105': PxExcLib + 'LIB' )
                      );
